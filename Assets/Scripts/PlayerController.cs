...
public class PlayerController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (isGrounded == true && !anchoredToObject)
        {
        ...
        #region AIR MOVEMENT
        if (isGrounded == false && _wallRunning == false && anchoredToObject == false)
        {
    ...
    public void AnchorToObject(Transform obj)
    {
